...
SAC_LOGIN_CONFIG = {
    "oidc_url": "__zulip_sac_login_discovery_url__",
    "client_id": "__zulip_sac_login_client_id__",
    "client_secret": get_secret("sac_oidc_secret"),
    "allowed_group_ids": ["__zulip_sac_login_uto_section_id__"],
}
...
S3_AVATAR_PUBLIC_URL_PREFIX = "__zulip_s3_avatar_public_url_prefix__"
